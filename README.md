...
PHASE 0からPHASE 4に加え、PHASE 5「トリケラ解禁」を実装しています。
...
- 評判40またはコンテスト2勝で解放されるトリケラ
- 固定大型区画の強化柵と、年間草補充費が必要な大型草餌場
- トリケラ専用の低速歩行・睡眠・happy・踏み鳴らし
- トリケラ観察と踏み鳴らしによる満足度・人気度・売店収益の上昇
- 昼夜、天候、効果音、ミュート、速度切替
...
キーは`jurapaku-save-v1`です。資金、評判、日数、昼夜、天候、施設座標、現役恐竜、卵、世代、保護年数、人気度、レジェンド、コンテスト、来園者図鑑、解放種、レア卵、トリケラ卵、音設定、ゲーム速度を保存します。旧形式のモコ1匹データは初代の`dinosaurs[]`へ自動移行します。
